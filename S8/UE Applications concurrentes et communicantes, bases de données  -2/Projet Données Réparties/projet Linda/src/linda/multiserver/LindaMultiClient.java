...
import linda.server.RCallBackImpl;

public class LindaMultiClient implements LindaMulti {

	private LindaMultiServer serveur; 
	private ArrayList<Tuple> cache;	
	
	/** Initializes the Linda implementation.
     *  @param serverURI the URI of the server, e.g. "rmi://localhost:4000/LindaServer" or "//localhost:4000/LindaServer".
     */
    public LindaMultiClient(String serverURI) {
        ...
        try { 
        	...
        	this.serveur = (LindaMultiServer) registry.lookup("LindaMulti");
