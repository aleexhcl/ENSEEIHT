...
(* chercher dans la tds mere de la tds donnée une variable par son nom*)
let chercherMere tds nom = match tds with 
  | Nulle -> None
  | Courante (m,_) -> chercherGlobalement m nom
