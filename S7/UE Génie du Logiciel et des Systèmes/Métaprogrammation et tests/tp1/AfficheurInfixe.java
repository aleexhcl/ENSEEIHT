...
public class AfficheurInfixe implements VisiteurExpression<String> {
	...
	@Override
	public String visiterExpressionDefinie(ExpressionDefinie e) {
	
		return "let " + e.getIdent().accepter(this) + " = " + e.getExpressionIdent().accepter(this) + " in " + e.getExpressionSuite().accepter(this);
 	}
